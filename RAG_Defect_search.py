...
st.set_page_config(page_title="Defect Searcher", page_icon="💬")
st.title("Defect Searcher")

DB_PATH = "./vectorstores/j_db/"
...
if user_input := st.chat_input("무엇이 궁금하신가요?"):
    ...
    with st.chat_message("assistant"):
        ...
        prompt = PromptTemplate.from_template(
            ...
            질문을 받으면 --Summary 열의 데이터중에 유사한 대답이 있는지 찾아줘
            그리고 찾는다면, 해당 행의 데이터를 요약해 주면 좋겠어
            여러개를 찾는다면, 줄바꿈을 해서 구분을 부탁해. 
