...
st.set_page_config(page_title="영향도 분석", page_icon="💬")
st.title("Payment dependencies analysis")
...
if user_input := st.chat_input("무엇이 궁금하신가요?"):
    ...
    with st.chat_message("assistant"):
        ...
        prompt = PromptTemplate.from_template(
            ...
            컨텍스트는 시퀀스 다이어그램이고 '결제요청'에서 부터 flow가 시작되어 화살표 방향으로 진행되.
            'PP Web', 'PP Core', 'SAC & TSAC', 'External Payment Service' 각 모듈의 이름이고 화살표를 따라 다른 모듈에 이동되면 해당 모듈에 영향를 줘.       
